...
class MainActivity : AppCompatActivity() {
    ...
    //Set menu icon based on which LayoutManager is currently being used
    ...
    //set icon based on LinearLayoutManager of RecyclerView
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        //when the layout icon is selected changes the isLinearLayoutManager to the opposite value
        //then changes layout and icon
        return when (item.itemId) {
            ...
            //Otherwise use the normal behavior of onOptionsItemSelected
